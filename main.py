...
INTERROGATION_SCRIPT = [
    ...
    {
        "hatter": "*подпрыгивает* Безумие? Ой, нет-нет-нет! Это ГЕНИАЛЬНО! *вскакивает на стол и размахивает руками* Вот слушай, слушай! Большой парень найдёт свою любимую. Газец Пугало ударит ему в нос — и он увидит в ней... *широко раскрывает глаза* ...ПУДИНГ! Своего злейшего врага! И что он сделает? *делает жест удара* БУМ! Убьёт её своими руками! Её сердечко остановится... *разводит руками* ...и Метрополис превратится в пепел! *хохочет, падает со стола*",
        "options": [
            "Супермен убьёт Лоис, думая что это Джокер... Вы заставите его стать убийцей!",
            "Это слишком сложно. Супермен не такой.",
            "А если он не найдёт Лоис?"
        ],
        "correct": "Супермен убьёт Лоис, думая что это Джокер... Вы заставите его стать убийцей!"
    },
    {
        "hatter": "*поднимается с пола, отряхивается* Не найдёт? Ой, детектив! *крутит пальцем у виска* Он ВСЕГДА находит свою Лоис! Она его слабость! Его крип-то-нит, ха-ха! *внезапно становится серьёзной* А знаешь, когда всё это случится? *смотрит на часы на стене, потом на тебя* Скоро. Очень-очень скоро. Пудинг уже ждёт сигнала. *улыбается*",
        "options": [
...
CRAFT_RULES = {
    "Common_to_Rare": {
        ...
        "to_rarity": "Rare",
        "count_needed": 5,
        "button_text": "5 Common → 1 Rare",
    },
    "Rare_to_Epic": {
        "from_rarity": "Rare",
        "to_rarity": "Epic",
        "count_needed": 10,
        "button_text": "10 Rare → 1 Epic",
    },
    "Epic_to_Legendary": {
        "from_rarity": "Epic",
        "to_rarity": "Legendary",
        "count_needed": 15,
        "button_text": "15 Epic → 1 Legendary",
    },
    "Legendary_to_Highlight": {
        "from_rarity": "Legendary",
        "to_rarity": "Highlight",
        "count_needed": 20,
        "button_text": "20 Legendary → 1 Highlight",
    },
    "RareTU_to_EpicTU": {
        "from_rarity": "Rare Team-up",
        "to_rarity": "Epic Team-up",
        "count_needed": 10,
        "button_text": "10 Rare Team-up → 1 Epic Team-up",
    },
        ...
        if text in correct_answers:
            ...
            if next_step < len(INTERROGATION_SCRIPT):
                ...
                explosion_text = (
                    ...
                    "Пуки будет гордиться — ты такой умничка.\n"
                    ...
                    "Он только что убил её своими руками, видя в ней Джокера. "
                    "Его рот открыт в беззвучном крике.\n\n"
                    "<b>План Джокера реализован.</b>\n\n"
                    "<b>💀 Конец первой главы.</b>"
                )

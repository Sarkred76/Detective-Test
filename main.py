...
INTERROGATION_SCRIPT = [
    ...
    {
        "hatter": "Модифицировал? Хорошая догадка, но это не совсем так. Я усовершенствовал формулу. Токсин страха — это же произведение химического искусства. А Джокер... Джокер попросил меня о кое-чём особенном.",
        "options": [
